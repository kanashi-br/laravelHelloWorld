  ...
  <div id="greywrap">
    <div class="row">
      <div class="col-lg-4 callout">
        ...
        <p>Digite /home na barra de endereço e vá para casa. Depois disso, seguir o "caminho" (trocadilho) será mais fácil.</p>
      </div>
      <!-- col-lg-4 -->
      <div class="col-lg-4 callout">
        <span class="icon icon-eye"></span>
        <h2>Requisito básico</h2>
        <p>O necessário para continuar é: não seja cego, por favor. </p>
      </div>
      <!-- col-lg-4 -->
      ...
      <div class="col-lg-4 callout">
        ...
        <h2>Jesus te ama</h2>
        <p>Se você souber disso não preciso falar mais nada. </p>
      </div>
      <!-- col-lg-4 -->
    </div>
    <!-- row -->
